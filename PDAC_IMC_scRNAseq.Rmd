---
title: "NK cell co-localization with epithelial cells in pancreatic cancer is influenced by fibroblasts and ECM components"
---
...
```{r Figure 2E Analysis: Distance Analysis}
...
```{r Figure 2F Analysis: Network Analyses}
...
## Figure 4
```{r Figure 4C-F Analysis: CellSelector}
...
write.csv(SF4, file = "SF4_df.csv") # open file to graph data in GraphPad Prism
```

## Supplementary Figure S10
```{r Supplementary Figure S10A}
